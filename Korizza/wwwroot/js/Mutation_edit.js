...
function edit() {
	...
	if (ittour_order_block_transport_info.length !== 0) {
		...
		var ittour_order_block_customer_info = document.querySelectorAll(".ittour_order_block_customer_info");
		ittour_order_block_customer_info.forEach(function (val) {
...
function searchResults() {
	...
	//    });
	//};
	var searchRes = document.querySelectorAll(".itt_results");
	searchRes.forEach(function(val) {
		val.style.removeProperty("width");
...
function removeColumn() {
	...
	document.querySelectorAll('.list_stars').forEach(function(val) {
...
//	if (event.target.closest('div.ittour_order_block_hotel_info1')) {
//		if (document.querySelectorAll("img.load_center")[0].isConnected == true) {
//			document.getElementById("isolated1")
